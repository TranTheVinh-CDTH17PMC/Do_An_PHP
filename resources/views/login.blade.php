                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    ...
                                    <p class="text-muted mb-4 mt-3">Vui lòng đăng nhập.</p>
                                </div>

                                <h5 class="auth-title">Đăng nhập</h5>

                                <form action="{{route('xuli-dangnhap')}}" method="POST">
                                    @csrf
                                ...
                                <div style="display: flex;">
                                  @php
                                 echo"<p style='color: #ff3600;font-style:bold; margin-top: 2em; font-size:15px; '>Đăng nhập không thành công</p>";
                                  @endphp
                                ...
                                <div class="text-center">
                                    ...
                                    <ul class="social-list list-inline mt-3 mb-0">
                                        <li class="list-inline-item">
                                            <a href=" {{ asset ( 'javascript: void(0);') }}" class="social-list-item border-primary text-primary"><i class="mdi mdi-facebook"></i></a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a href="{{ asset ( 'javascript: void(0);') }}" class="social-list-item border-danger text-danger"><i class="mdi mdi-google"></i></a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a href="{{ asset ( 'javascript: void(0);') }}" class="social-list-item border-info text-info"><i class="mdi mdi-twitter"></i></a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a href="{{ asset ( 'javascript: void(0);') }}" class="social-list-item border-secondary text-secondary"><i class="mdi mdi-github-circle"></i></a>
                                        </li>
                                    </ul>
                                </div>
